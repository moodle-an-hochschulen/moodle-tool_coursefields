...
$string['nopossiblerequired'] = 'Not possible for required fields';
...
$string['overwritemode_clear'] = 'Clear the field for all courses';
$string['overwritemode_empty'] = 'Only set the field for courses where the field is empty';
$string['overwritemode_help'] = 'Choose how you want to update the field values.<br /><ul><li>Do not change the field at all:<br />If you select this option, the field will not be touched at all after you submit this form.</li><li>Overwrite the field for all courses:<br />If you select this option, the field will be overwritten with the given value, regardless of its previous value.</li><li>Clear the field for all courses:<br />If you select this option, the field will be cleared (set to empty) for all courses, regardless of its previous value. Please note that this mode is only available for selected field types.</li><li>Only set the field for courses where the field is empty:<br />If you select this option, the field will be only be set to the given value if it does not contain a non-empty value yet. Please note that this mode is only available for selected field types.</li></ul>';
